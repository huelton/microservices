package com.project.microservice.communication.buytrip.gateway.http;
...
import com.project.microservice.communication.buytrip.gateway.json.CompraChaveJson;
import com.project.microservice.communication.buytrip.gateway.json.CompraJson;
import com.project.microservice.communication.buytrip.gateway.json.RetornoJson;
...
public class CompraController {
	...
	public ResponseEntity<RetornoJson> pagamento(
		...
		retorno.setMensagem("Compra registrada com sucesso. Aguardando a confirmação do pagamento.");
